...
from cs336_systems.flash_attn import PytorchFlashAttnFunc, TritonFlashAttnFunc
from cs336_systems.playground.distributed.ddp import DDPWrapper, DDPBucketedWrapper
...
def get_ddp_bucketed(module: torch.nn.Module, bucket_size_mb: float) -> torch.nn.Module:
    ...
    Returns:
        Instance of a DDP class.
    """
    return DDPBucketedWrapper(module, bucket_size_mb)
